...
var app = (function () {
    ...
    // (63:6) {#each images as image, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			? "appearing"
    			: "disappearing") + " svelte-15a6h5k"));

    			attr_dev(img, "alt", "Frame");
    			add_location(img, file, 63, 8, 1090);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:6) {#each images as image, index}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "wrapper svelte-15a6h5k");
    			add_location(div, file, 59, 0, 983);
    		},
